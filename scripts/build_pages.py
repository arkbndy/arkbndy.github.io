  ...
  <div class="wrap">
    <div class="hero-grid">
      <div>
        ...
        <p class="lede">I am a theoretical condensed-matter physicist working on quantum materials.
          My research asks how the geometry of electronic states shows up in what a material conducts, how
          lattice structure and symmetry generate Dirac states, flat bands and topological phases, and how
          magnetic order and electronic correlations reshape all of it. My work combines first-principles
          electronic structure and Wannier-based methods with symmetry-adapted minimal model Hamiltonians,
          topological analysis, quantum transport and many-body approaches, used together to connect a
          microscopic mechanism to something a measurement can detect. Several projects run with
          experimental groups working across disciplines, whose command of synthesis and measurement is
          what makes many of these questions answerable.</p>
        <div class="actions">
